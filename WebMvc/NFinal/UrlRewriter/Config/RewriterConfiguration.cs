...
namespace NFinal.URLRewriter.Config
{
	/// <summary>
	...
	public class RewriterConfiguration
	{
		...
		public static RewriterConfiguration GetConfig()
		{
			if (HttpContext.Current.Cache["RewriterConfig"] == null)
                ...
                HttpContext.Current.Cache.Insert("RewriterConfig", System.Configuration.ConfigurationManager.GetSection("RewriterConfig"));
