...
namespace {$project}.{$app}.Web.Default.Common.Public
{
    public class SuccessAction  : Controller
	{
		public SuccessAction(System.IO.TextWriter tw):base(tw){}
		public SuccessAction(string fileName) : base(fileName) {}
