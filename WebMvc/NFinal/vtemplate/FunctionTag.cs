...
namespace VTemplate.Engine
{
    ...
    public class FunctionTag : Tag
    {
        ...
        private ElementCollection<IExpression> functionArgs;
        #region 属性定义
        /// <summary>
        /// 参与函数运算的参数列表
        /// </summary>
        public virtual ElementCollection<IExpression> FunctionArgs { get { return functionArgs; } protected set { functionArgs = value; } }
        ...
        private VariableIdentity variable;
        /// <summary>
        /// 存储表达式结果的变量
        /// </summary>
        public VariableIdentity Variable { get { return variable; } protected set { variable = value; } }

        private bool output;
        /// <summary>
        /// 是否输出此标签的结果值
        /// </summary>
        public bool Output { get { return output; } protected set { output = value; } }
        #endregion
