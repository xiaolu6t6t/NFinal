...
namespace VTemplate.Engine
{
    ...
    public class VariableExpression : IExpression
    {
        ...
        private VariableIdentity variableId;
        /// <summary>
        /// 变量标识
        /// </summary>
        public VariableIdentity VariableId { get { return variableId; } private set { variableId = value; } }
        private string fieldName;
        /// <summary>
        /// 字段名
        /// </summary>
        public string FieldName { get { return fieldName; } private set { fieldName = value; } }
        private bool isMethod;
        /// <summary>
        /// 是否是方法
        /// </summary>
        public bool IsMethod { get { return isMethod; } private set { isMethod = value; } }

        private bool needCacheData;
        /// <summary>
        /// 是否需要缓存数据
        /// </summary>
        /// <remarks>一般在变量标签出现的变量表达式的值都需要缓存.其它地方出现的则不需要缓存</remarks>
        private bool NeedCacheData { get { return needCacheData; } set { needCacheData = value; } }

        private VariableExpression parentExpression;
        /// <summary>
        /// 取得父级表达式
        /// </summary>
        private VariableExpression ParentExpression { get { return parentExpression; } set { parentExpression = value; } }
        private VariableExpression nextExpression;
        /// <summary>
        /// 取得下一个表达式
        /// </summary>
        private VariableExpression NextExpression { get { return nextExpression; } set { nextExpression = value; } }
