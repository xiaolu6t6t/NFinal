...
namespace VTemplate.Engine
{
    ...
    public class VariableTag : Element, IAttributesElement
    {
        ...
        /// 此标签的属性集合
        /// </summary>
        public AttributeCollection Attributes { get { return attributes; } protected set { attributes = value; } }

        private VariableExpression varExpression;
        /// <summary>
        /// 变量元素中的变量表达式
        /// </summary>
        public VariableExpression VarExpression { get { return varExpression; } private set { varExpression = value; } }
        ...
        public List<IExpression> callFunctions;
        /// <summary>
        /// 要调用的函数列表
        /// </summary>
        public List<IExpression> CallFunctions { get { return callFunctions; } protected set { callFunctions = value; } }
        #endregion
