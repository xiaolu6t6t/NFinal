...
namespace VTemplate.Engine
{
    ...
    public class TemplateDocumentConfig
    {
        ...
        private TagOpenMode tagOpenMode;
        /// <summary>
        /// 标签的开放模式
        /// </summary>
        public TagOpenMode TagOpenMode { get { return tagOpenMode; } private set { tagOpenMode = value; } }
        ...
        /// </remarks>
        public bool CompressText { get { return compressText; } private set { compressText = value; } }

        private bool compatibleMode;
        /// <summary>
        /// 兼容模式
        /// </summary>
        /// <remarks>如果采用兼容模式.则&lt;vt:foreach&gt;标签的from属性与&lt;vt:expression&gt;标签的args属性等可以不以$字符开头定义变量表达式</remarks>
        public bool CompatibleMode { get { return compatibleMode; } private set { compatibleMode = value; } }
    }
}
