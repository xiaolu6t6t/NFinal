...
namespace VTemplate.Engine
{
    ...
    public class ForEachTag : Tag
    {
        ...
        #region 属性定义
        private VariableExpression from; 
        /// <summary>
        /// 来源数据的变量
        /// </summary>
        public VariableExpression From { get { return from; } protected set { from = value; } }
        private VariableIdentity item;
        /// <summary>
        /// 当前项变量
        /// </summary>
        public VariableIdentity Item { get { return item; } protected set { item = value; } }
        private VariableIdentity index;
        /// <summary>
        /// 索引变量
        /// </summary>
        public VariableIdentity Index { get { return index; } protected set { index = value; } }
