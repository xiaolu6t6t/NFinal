...
namespace VTemplate.Engine
{
    ...
    public class DataReaderTag : Tag
    {
        ...
        private ElementCollection<IExpression> parameters;
        /// <summary>
        /// 查询命令中使用的变量参数列表,各参数在查询命令语句中则用参数名代替.如"@p0","@p1"之类的参数名
        /// </summary>
        public virtual ElementCollection<IExpression> Parameters { get { return parameters; } protected set { parameters = value; } }
        #endregion
