...
namespace VTemplate.Engine
{
    ...
    public class IfConditionTag : Tag
    {
        ...
        /// 条件变量
        /// </summary>
        public virtual VariableExpression VarExpression { get { return varExpression; } protected set { varExpression = value; } }
        private ElementCollection<IExpression> values;
        /// <summary>
        /// 比较值列表
        /// </summary>
        public virtual ElementCollection<IExpression> Values { get { return values; } protected set { values = value; } }
        /// <summary>
        /// 比较类型
        /// </summary>
