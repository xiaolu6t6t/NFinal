...
namespace VTemplate.Engine
{
    ...
    public abstract class Tag : Element, IAttributesElement
    {
        ...
        private ElementCollection<Element> innerElements;
        /// <summary>
        /// 此标签包含的子元素集合
        /// </summary>
        public ElementCollection<Element> InnerElements { get { return innerElements; } private set { innerElements = value; } }
