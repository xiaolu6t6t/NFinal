...
namespace VTemplate.Engine
{
    ...
    public class Template : Tag
    {
        ...
        /// 模板的关联文件
        /// </summary>
        public string File { get { return file; } internal set { file = value; } }

        private Encoding charset;
        /// <summary>
        /// 模板数据采用的编码
        /// </summary>
        public Encoding Charset { get { return charset; } internal set { charset = value; } }
        ...
        /// 返回此模板下的变量集合
        /// </summary>
        public VariableCollection Variables { get { return variables; } private set { variables = value; } }

        private UserDefinedFunctionCollection userDefinedFunctions;
        /// <summary>
        /// 自定义函数集合
        /// </summary>
        public UserDefinedFunctionCollection UserDefinedFunctions { get { return userDefinedFunctions; } private set { userDefinedFunctions = value; } }

        private ElementCollection<Template> childTemplates;
        /// <summary>
        /// 返回此模板下的子模板元素
        /// </summary>
        public ElementCollection<Template> ChildTemplates { get { return childTemplates; } set { childTemplates = value; } }

        private Template tagContainer;
        /// <summary>
        /// 标签容器
        /// </summary>
        protected Template TagContainer { get { return tagContainer; } set { tagContainer = value; } }
