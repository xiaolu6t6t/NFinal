...
namespace VTemplate.Engine
{
    ...
    public class LoopIndex : IConvertible, IComparable
    {
        ...
        /// 值
        /// </summary>
        public decimal Value { get { return v; } internal set { v = value; } }

        private bool isFirst;
        /// <summary>
        /// 是否是第一个索引值
        /// </summary>
        public bool IsFirst { get { return isFirst; } internal set { isFirst = value; } }

        private bool isLast;
        /// <summary>
        /// 是否是最后一个索引值
        /// </summary>
        public bool IsLast { get { return isLast; } internal set { isLast = value; } }
